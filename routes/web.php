...
Route::prefix('usuarios')->middleware('auth', 'Checkrol:invitado')->group(function(){
    Route::get('/create-invitado', [Usuarios::class, 'createInvitado'])->name('usuarios.createinvitado');
});